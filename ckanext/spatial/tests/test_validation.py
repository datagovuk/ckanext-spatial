...
'''
    ...
    def test_schematron_error_location_simplification(self):
        ...
        assert_equal(validation.SchematronValidator.simplify_error_location("/*[local-name()='MD_Metadata' and namespace-uri()='http://www.isotc211.org/2005/gmd']/*[local-name()='distributionInfo' and namespace-uri()='http://www.isotc211.org/2005/gmd']/*[local-name()='MD_Distribution' and namespace-uri()='http://www.isotc211.org/2005/gmd']"),
